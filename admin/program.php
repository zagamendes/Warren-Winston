        ...
        <div class="row">
            ...
            <div class="col-sm-6 ">
                ...
                <a href="programphotos">
                    <button class="btn btn-primary btn-block text-uppercase font-weight-bold"><span
                            class="fas fa-images"></span> Edit Pictures</button>
                </a>
            ...
            <div class="col-sm-6">
                <form action="../processes/process program.php" method="post">
                    ...
                    <button class="btn btn-success btn-block font-weight-bold text-uppercase form-control"><span
