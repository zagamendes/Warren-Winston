...
<div class="container">
    ...
    <div class="row" style="margin-top: 20px; margin-bottom: 20px;">
        ...
        <div class="col-sm-4">
            <button class="btn btn-lg btn-block text-uppercase font-weight-bold" data-toggle="modal"
                data-target="#home">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="../processes/save photo" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="btn  btn-primary font-weight-bold btn-block text-uppercase"><span
                                    class="fas fa-image"></span> select photo
                ...
                <div class="modal-body">
                    <form method="post" action="../processes/process testimony" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="testimony" class="form-control" rows="3" required
                                placeholder="E.G. Brief message about what the person has to say about your service.">
							</textarea>
                        </div>
