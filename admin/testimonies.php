...
<div class="container">
	...
	?>
	<h3 style="text-align: center; margin-bottom: 20px;" class="font-weight-bold text-uppercase">List Of Testimonies
	</h3>
		...
		<tbody>
			<?php foreach ($testimonies as $testimony) { ?>
				<tr>
					...
					<td><a href="testimony?id=<?= $testimony->getId() ?>" class="btn btn-primary text-uppercase font-weight-bold"><span class="fas fa-edit"></span> Edit
						</a></td>
					<td>
