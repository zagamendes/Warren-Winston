					...
					<tbody>
						<?php foreach ($photos as $photo) { ?>
							...
							<tr>
								...
								<td><a class="btn btn-danger" onclick="return confirm('are you sure that you want to delete this?');" href="../processes/delete.php?id=<?=$photo->getId();?>&table=photo_slideshow_workshop&photo=<?=$photo->getPhoto();?>&page=workshopslideshow">
