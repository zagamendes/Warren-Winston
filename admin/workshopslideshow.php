...
<div class="container">
    <legend>
        <h2 class="font-weight-bold text-uppercase text-center">Photos of home page</h2>
    </legend>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="../processes/save photo" enctype="multipart/form-data" method="post">
                        <input type="hidden" name="page" value="workshopslideshow">
    ...
    <table class="table table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <button class="btn btn-primary text-uppercase font-weight-bold" data-id="<?= $photo->getId() ?>"
                        data-title="<?= $photo->getTitle() ?>" data-description="<?= $photo->getDescription() ?>"
                        data-oldPhoto="<?= $photo->getPhoto() ?>"><span class="fas fa-edit"></span> Edit</button>
                </td>
                <td><a class="btn btn-danger" onclick="return confirm('are you sure that you want to delete this?');"
                        href="../processes/delete.php?id=<?= $photo->getId(); ?>&table=photo_slideshow_workshop&photo=<?= $photo->getPhoto(); ?>&page=workshopslideshow">
