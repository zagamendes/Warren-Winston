...
<div class="container">
    ...
    <legend>
        <h3 class="font-weight-bold text-uppercase text-center">Registration Of Testimonies</h3>
    </legend>
    <form action="../processes/process testimony.php" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?= $testimony->getName() ?>" name="name"
                        required="required" placeholder="Ex: Izaac Mendes">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
                    <label>Occupation:</label>
                    <input type="text" class="form-control" value="<?= $testimony->getOccupation() ?>"
                        placeholder="Ex: Web Developer" required name="occupation">
                </div>
            </div>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label>Picture:</label>
                    <label class="btn btn-primary btn-block font-weight-bold text-uppercase"><span
                            class="fas fa-image"></span> Picture
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <button class="btn btn-success btn-block font-weight-bold text-uppercase"><span
