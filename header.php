						...
						<div class="navbar-header">
							...
							<div id="barra-navegacao" class="collapse navbar-collapse">
								<ul class="nav navbar-nav navbar-right">
										...
										<li id="programs"  <?php if($currentPage==="business.php"||$currentPage==="program.php"||$currentPage==="workshops.php")echo 'class=active';?>><a href="#">Programs<span class="caret"></span></a>
